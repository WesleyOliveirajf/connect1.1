  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="icon" className="bg-card/50 backdrop-blur-sm border-border/60 hover:bg-card/80 transition-all duration-200 hover:scale-105 hover:shadow-lg">
